...
const firebaseConfig = {
  ...
  storageBucket: "feedback-flow-tnxre.appspot.com",
...
const storage = firebaseCredentialsProvided ? getStorage(app) : null;
const googleProvider = firebaseCredentialsProvided ? new GoogleAuthProvider() : null;

export { app, auth, db, storage, googleProvider, firebaseCredentialsProvided };
